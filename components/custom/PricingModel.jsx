    ...
    gap-5'>
        {Lookup.PRICING_OPTIONS.map((pricing,index)=>(
            ...
            >
                ...
                <h2 className='font-bold text-center text-4xl mt-6'>${pricing.price}</h2>
                <PayPalButtons onClick={()=>{setSelectedOption(pricing);console.log(pricing.value)}} style={{ layout: "horizontal" }}
