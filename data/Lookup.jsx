...
export default {
  ...
  SIGNIN_HEADING: 'Continue With WebEase AI',
  SIGNIN_SUBHEADING: 'To use WebEase AI you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using WebEase AI, you agree to the collection of usage data for analytics.',
...
`
  ...
  PRICING_OPTIONS:[
    ...
    },
    {
      ...
      tokens:'120K',
      value:120000,
      desc:'Designed for professionals who need to use WebEase AI a few times per week.',
      price:9.99
    },
    {
      name:'Pro',
